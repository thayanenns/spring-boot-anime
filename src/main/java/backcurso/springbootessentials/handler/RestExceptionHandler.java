package backcurso.springbootessentials.handler;

import backcurso.springbootessentials.exception.BadRequestException;
import backcurso.springbootessentials.exception.BadRequestExceptionDetails;
import backcurso.springbootessentials.exception.ExceptionDetails;
import backcurso.springbootessentials.exception.ValidationExceptionDetails;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<BadRequestExceptionDetails> handleBadResquestException(BadRequestException exception){
